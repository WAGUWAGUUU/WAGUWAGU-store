...
public enum UpdateStoreType {
    STORE_NAME, STORE_ADDRESS_STRING, STORE_OPEN_AT,STORE_CLOSE_AT,STORE_PHONE,STORE_MINIMUM_ORDER_AMOUNT,STORE_INTRODUCTION, STORE_CATEGORY;
    public static UpdateStoreType stringToStoreType(String type){
        switch(type) {
            case "store-name":
                return UpdateStoreType.STORE_NAME;
            case "store-address-string":
                return UpdateStoreType.STORE_ADDRESS_STRING;
            case "store-open-at":
