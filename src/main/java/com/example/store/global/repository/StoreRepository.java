...
@Query(value = "SELECT ownerId,storeId,storeName,storeAddress,storeLongitude,storeLatitude,storeMinimumOrderAmount,storeIntroduction, storeBlockIsOpened, storeImage" +
        " FROM (" +
        "   SELECT S.owner_id AS ownerId, S.store_id AS storeId, S.store_name AS storeName, S.store_address AS storeAddress, " +
        "          S.store_latitude AS storeLatitude, S.store_longitude AS storeLongitude, " +
        "          S.store_minimum_order_amount AS storeMinimumOrderAmount, S.store_introduction AS storeIntroduction, " +
        "          S.store_block_is_opened AS storeBlockIsOpened, S.store_open_at AS storeOpenAt, " +
        "          S.store_close_at AS storeCloseAt, S.store_image AS storeImage, " +
...
List<StoreNearUserResponse> findStoreAllNearUser(@Param("userLongitude") double userLongitude, @Param("userLatitude") double userLatitude, @Param("category") String category);
    ...
    @Query(value = "SELECT ownerId,storeId,storeName,storeAddress,storeLongitude,storeLatitude,storeMinimumOrderAmount,storeIntroduction, storeBlockIsOpened, storeImage" +
            ...
            "ORDER BY distance",
            nativeQuery = true)
    List<StoreNearUserResponse> findStoreAllNearUserAll(@Param("userLongitude") double userLongitude, @Param("userLatitude") double userLatitude);
